...
public class JsonUtil {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("------------------");
			String beanStr = "{\"age\":10,\"userName\":\"weisihua\",\"birthDay\":\"2018-07-25 15:52:08\"}";
			String listStr = "[{\"age\":10,\"userName\":\"weisihua\",\"birthDay\":\"2018-07-25 15:52:08\"}]";
			TestUser u = json2Bean(beanStr, TestUser.class);
			System.out.println(u.getUserName());
			List<TestUser> list2 = json2List(listStr, TestUser.class);
			for(TestUser t : list2) {
